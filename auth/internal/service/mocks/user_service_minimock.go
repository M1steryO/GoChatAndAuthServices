...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, user *model.CreateUserModel) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, user *model.CreateUserModel)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, user *model.CreateUserModel) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) ExpectUserParam2(user *model.CreateUserModel) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, user *model.CreateUserModel)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *model.CreateUserModel) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, user *model.CreateUserModel) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *model.CreateUserModel) (i1 int64, err error) {
